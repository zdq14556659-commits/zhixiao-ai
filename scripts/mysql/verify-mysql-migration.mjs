...
try {
  ...
  const followProjection = collectProjectedFollowUps(state, dataFile);
  const expectedFollowUps = followProjection.entries.length;
  console.log(`MYSQL_FOLLOWUPS_EXPECTED ${formatFollowUpProjectionStats(followProjection.stats)}`);
