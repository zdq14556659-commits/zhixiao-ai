...
sheet.getRange("A1:M5").values = [
  headers,
  ["杭州雅居全屋定制工厂", "13800138000", "杭州市", "浙江省杭州市余杭区示例路88号", "企查查", "V1", "杭州一部", "运营小组", "张销售", "已电话联系，老板关注设计拆单一体化", "2026-06-14", "2026-06-16", "三维家"],
  ["佛山柜体门板厂", "13900139000", "佛山市", "广东省佛山市顺德区示例工业园", "地推", "ERP", "佛山一部", "运营小组", "李销售", "准备安排现场演示", "2026-06-14", "2026-06-18", "云熙"],
  ["", "", "", "", "", "", "", "", "", "", "", "", ""],
  ["", "", "", "", "", "", "", "", "", "", "", "", ""]
];
...
sheet.getRange("A2:M1000").format = {
...
sheet.getRange("A2:M3").format.fill = "#F7FAFC";
...
guide.getRange("A3:B17").format.borders = { preset: "all", style: "thin", color: "#E4E9F0" };
guide.getRange("A4:A17").format.font = { bold: true, color: "#243447" };
guide.getRange("A:A").format.columnWidth = 22;
guide.getRange("B:B").format.columnWidth = 78;
guide.getRange("B4:B17").format.wrapText = true;
guide.freezePanes.freezeRows(3);

const preview = await workbook.render({ sheetName: "客户导入模板", range: "A1:M6", scale: 1.5, format: "png" });
...
const inspection = await workbook.inspect({ kind: "table", range: "客户导入模板!A1:M5", include: "values,formulas", tableMaxRows: 8, tableMaxCols: 14 });
